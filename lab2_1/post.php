        ...
        <main>
            <div class="main-content">            
                <div class="main-content__title">
                    <h2 class="main-content__title-item title"><?= $page['id'] ?><?php echo ' ' ?><?= $page['title'] ?></h2>
                    <h2 class="main-content__title-item subtitle"><?= $page['subtitle'] ?></h2>
                </div>
                <img class="image" src="<?= $page['image'] ?>" alt="<?= $page['alt'] ?>">
                <div class="main-content__text text">
                    <?php foreach ($page['texts'] as $text): ?>
                        <p><?= $text ?></p>
                    <?php endforeach; ?>
                </div>
            </div>
