        ...
        <main>
            <div class="main-content">            
                ...
                <div class="main-content__text text">
                    <p><?php echo $post['texts']['first-text'] ?></p>
                    <p><?php echo $post['texts']['second-text'] ?></p>
                    <p><?php echo $post['texts']['third-text'] ?></p>
                    <p><?php echo $post['texts']['fourth-text'] ?></p>
                </div>
            </div>
        </main>
        <footer class="footer">
