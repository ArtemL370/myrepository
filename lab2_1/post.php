...
$post = [
    ...
    'image' => '/static/images/picture1.jpg',
    'alt' => 'Northern lights',
]
?>
	...
	<body>
        <header>
            <div class="header-content container">
                <a href="home" class="header-content__logo logo">Escape.</a>                
                <nav class="header-content__menu">
                    <ul class="header-content__menu-list list">
                        <li><a href="home" class="header-content__menu-link link">HOME</a></li>
        ...
        <main>
            <div class="main-content">            
                ...
                <div class="main-content__text text">
                    <?php foreach ($post['texts'] as $text): ?>
                        <p><?= $text ?></p>
                    <?php endforeach; ?>
                </div>
            </div>
        ...
        <footer class="footer">
            <div class="footer-content container">
                <a href="home" class="footer-content__logo logo">Escape.</a>
                <nav class="footer-content__menu">
                    <ul class="footer-content__menu-list list">
                        <li><a href="home" class="footer-content__menu-link link">HOME</a></li>
