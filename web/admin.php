    ...
    <form class="form admin-form container-admin" action="">
        <div class="admin-form__header">
            ...
            <div class="admin-form__main">
                <div class="admin-form__error-field hidden" id="error">
                    <span class="admin-form__error-text">A-Ah! Check all fields</span>
                </div>
                <div class="admin-form__success-field hidden" id="success">
                    <span class="admin-form__success-text">Publish complete!</span>
                </div>`
            ...
            <div class="admin-form__inputs-block-wrapper">
                <div class="admin-form__inputs-block">
                    <div class="admin-form__input-wrapper admin-form__input-wrapper_title">
                        ...
                        <input class="admin-form__input" type="text" name="title" id="js-title" placeholder="New Post" maxlength="255">
                    ...
                    <div class="admin-form__input-wrapper admin-form__input-wrapper_author" id="drop-area-author">
                        <label class="admin-form__label admin-form__label_author-photo" >
                            Author Photo
                        </label>
                        <input class="admin-form__input admin-form__input_file" multiple accept="image/*" type="file" id="author_photo" hidden>
                        <span class="admin-form__view-photo admin-form__view-photo_author" id="js-author-photo">
                            <img class="admin-form__photo admin-form__photo_icon" src="/images/icon/camera.svg" alt="Author Photo" >
                        </span>
                        <span class="admin-form__button admin-form__button_upload" id="author-button-upload">
                            Upload
                        </span>
                        <span class="admin-form__button admin-form__button_remove" id="author-photo-remove">
                            <img class="admin-form__photo admin-form__photo_button" src="/images/icon/trash-red.svg" alt="Author Photo">
                            Remove
                        </span>
                        <span class="admin-form__hidden-error admin-form__hidden-error_author-name"></span>
                    </div>
                    ...
                    <div class="admin-form__input-wrapper admin-form__input-wrapper_image-large" id="drop-image-large">
                        ...
                        <input class="admin-form__input admin-form__input_file" multiple accept="image/*" type="file" id="image-large" hidden>
                        <span class="admin-form__view-photo admin-form__view-image_large" id="js-image-large">
                            <img class="admin-form__photo admin-form__photo_icon admin-form__photo_icon_large" src="/images/icon/camera.svg" alt="Author Photo">
                        </span>
                        <div class="admin-form__button-wrapper">
                            <span class="admin-form__button image-large_button_large-upload" id="image-large_button_upload">
                                <img class="admin-form__photo admin-form__photo_button" src="/images/icon/camera.svg" alt="Author Photo">
                                Upload New
                            </span>
                    ...
                    <div class="admin-form__input-wrapper admin-form__input-wrapper_image-small" id="drop-image-small">
                        ...
                        <input class="admin-form__input admin-form__input_file" multiple accept="image/*" type="file" id="image-small" hidden>
                        <span class="admin-form__view-photo admin-form__view-image_small" id="js-image-small">
                            <img class="admin-form__photo admin-form__photo_icon admin-form__photo_icon_small" src="/images/icon/camera.svg" alt="Author Photo">
                        </span>
                        <div class="admin-form__button-wrapper">
                            <span class="admin-form__button image-large_button_small-upload" id="image-small_button_upload">
                                <img class="admin-form__photo admin-form__photo_button" src="/images/icon/camera.svg" alt="Author Photo">
                                Upload New
                            </span>
